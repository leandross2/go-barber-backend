...
var ApointmentsRepository_1 = __importDefault(require("../respositories/ApointmentsRepository"));
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsRepository, appontmentDate, findAppointmentInSameDate, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentsRepository = typeorm_1.getCustomRepository(ApointmentsRepository_1.default);
                        appontmentDate = date_fns_1.startOfHour(date);
                        return [4 /*yield*/, appointmentsRepository.findByDate(appontmentDate)];
                    case 1:
